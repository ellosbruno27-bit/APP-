...
import { Mail, ArrowRight, ArrowLeft, UserCheck } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 -right-40 w-[500px] h-[500px] bg-[#D4A853]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 -left-40 w-[500px] h-[500px] bg-[#D4A853]/5 rounded-full blur-3xl" />
      ...
      <div className="relative z-10 w-full max-w-md px-6">
        ...
        <div className="flex flex-col items-center mb-10">
          ...
          <div className="flex items-center gap-2 mt-2">
            <UserCheck size={16} className="text-[#D4A853]" />
            <p className="text-[#D4A853] text-sm font-medium tracking-wide">
              Acesso Afiliado
            </p>
          </div>
        </div>
          ...
          <div className="space-y-5">
            ...
            <div className="text-center space-y-2">
              <div className="w-14 h-14 rounded-full bg-[#D4A853]/10 border border-[#D4A853]/30 flex items-center justify-center mx-auto mb-4">
                <UserCheck size={24} className="text-[#D4A853]" />
              </div>
              <p className="text-[#B0B0B0] text-sm leading-relaxed">
                Clique no botão abaixo para acessar sua conta de afiliado com
                autenticação segura.
              </p>
            </div>
